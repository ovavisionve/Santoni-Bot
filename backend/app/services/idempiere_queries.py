...
def build_sales_summary(
    ...
    try:
        ...
        totals_q = text(
            ...
            f"LEFT JOIN adempiere.c_salesregion sreg ON sr.c_salesregion_id = sreg.c_salesregion_id "
            f"WHERE {where}"
        )
...
def build_overdue_receivables() -> list[dict]:
    ...
    try:
        q = text(
            ...
            "LEFT JOIN adempiere.c_salesregion sreg ON sr.c_salesregion_id = sreg.c_salesregion_id "
