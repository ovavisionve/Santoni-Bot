            ...
            messages.append(
                SystemMessage(
                    content=(
                        ...
                        "- DEBES presentar TODAS las secciones de datos que aparecen abajo. Si hay secciones de "
                        "Ausentismo, Nómina, Vacaciones, Rotación u otras, PRESÉNTALAS TODAS.\n"
                        "- NO digas 'no se encontraron datos' si hay datos aquí abajo. Lee TODO el bloque antes de responder.\n"
                        ...
                        "- SOLO di 'no se encontraron datos' si el bloque de datos está VACÍO o dice 'Error al consultar'.\n"
